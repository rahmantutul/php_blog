            ...
            <ul class="nav main">
                ...
                <?php 
                 if(Session::getSession('user_role')==1){
                    echo "<li class='ic-form-style'><a href='adduser.php'><span>ADD USER</span></a></li>";
                 }
                ?>
				...
				<li class="ic-grid-tables"><a href="seenmessage.php"><span>Seen Message
                <?php
